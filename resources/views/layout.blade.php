  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="/TODO"><i class="fa fa-dashboard"></i> <span>Data ToDo</span></a></li>
        <li><a href="/category"><i class="fa fa-dashboard"></i> <span>Data Category</span></a></li>        
        <li><a href="/user"><i class="fa fa-dashboard"></i> <span>Data User</span></a></li>
